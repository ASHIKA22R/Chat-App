    ...
    <div className="p-1 md:p-2 bg-base-200 fixed bottom-2">
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 p-2 rounded-lg md:rounded-xl focus:outline-none focus:ring-1 focus:ring-primary transition-colors text-gray-100 bg-slate-700 shadow-sm border border-base-300 text-sm md:text-base xl:w-237.5 sm:w-130"
          value={text}
